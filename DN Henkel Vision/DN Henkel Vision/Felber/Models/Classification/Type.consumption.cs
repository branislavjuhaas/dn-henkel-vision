...
namespace DN_Henkel_Vision
{
    public partial class TypeModel
    {
        ...
        private static readonly string MLNetModelPath = Windows.ApplicationModel.Package.Current.InstalledPath + @"\DN Henkel Vision\Felber\Models\Classification\Type.zip";
